...
export const wellnessApi = {
  summary: () => apiClient.get('/wellness/summary'),
  history: () => apiClient.get('/wellness/history'),
  checkIn: (data) => apiClient.post('/wellness/check-in', data),
  trends: () => apiClient.get('/wellness/trends'),
  sleepLm: () => apiClient.get('/wellness/sleeplm'),
  menta: () => apiClient.get('/wellness/menta'),
};
